...
`Home.tsx`) - the four pages below are **URL-only**, reached from the hub,
mirroring how `/item` is only reached from `/items`.

The four demand-side pages show as live, linked cards. The recipe-dependent Tier
B/C use cases from [#98](https://forgejo.coilysiren.me/coilyco-gaming/eco-app/issues/98)
(what X is made from / used in, how to price X, value per profession) show as
...
follow-ups A-E on [#98](https://forgejo.coilysiren.me/coilyco-gaming/eco-app/issues/98),
...
No recipe-shaped or cost/margin content lives here - the recipes page, cost
engine, value-per-profession, and "how to price X" page are follow-ups A-E on
[#98](https://forgejo.coilysiren.me/coilyco-gaming/eco-app/issues/98), gated on
the recipe exporter. This slice is demand-side only.
